...
/// <summary>
/// Source generator for creating AOT-compatible object factories
/// </summary>
[Generator]
public class AotObjectFactoryGenerator : IIncrementalGenerator
{
    ...
    private static void Execute(Compilation compilation, ImmutableArray<ClassDeclarationSyntax> classes, SourceProductionContext context)
    {
        ...
        {
            // Format generated code to avoid false positive in namespace detection tests
            var namespaceDeclaration = "namespace Rdmp.Core.Generated.Factories";
