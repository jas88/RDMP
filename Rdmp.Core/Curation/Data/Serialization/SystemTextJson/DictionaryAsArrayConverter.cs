...
/// </summary>
/// <remarks>
/// This is the System.Text.Json equivalent of the legacy Newtonsoft.Json DictionaryAsArrayResolver.
...
public class DictionaryAsArrayConverterFactory : JsonConverterFactory
{
    ...
    public override JsonConverter CreateConverter(Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return (JsonConverter)AotObjectConstructor.Construct(converterType);
    }
}
