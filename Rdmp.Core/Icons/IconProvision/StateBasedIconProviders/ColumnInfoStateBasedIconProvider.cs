...
{
    private static readonly Image<Rgba32> ColumnInfo = CatalogueIcons.ColumnInfo;
    private static readonly Image<Rgba32> ColumnInfoWithANO = CatalogueIcons.ANOColumnInfo;
